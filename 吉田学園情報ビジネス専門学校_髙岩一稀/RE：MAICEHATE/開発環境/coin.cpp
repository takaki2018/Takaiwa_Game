...
//--------------------------------------------------------------------------------------------------------------
// オブジェクトの当たり判定
// 引数		：*pPos		- 参照したい現在の座標のポインタ
//			：*pPosOld	- 参照したい前回の座標のポインタ
//			：*pvtxMin	- 参照したい最小座標のポインタ
//			：*pvtxMax	- 参照したい最大座標のポインタ
// 返り値	：bool		- コインにあたったかどうか返す
//--------------------------------------------------------------------------------------------------------------
