...
{
	// 変数宣言
	RECT rect = { 5,100,SCREEN_WIDTH,SCREEN_HEIGHT };
	char aStr[1024];
	...
	nNum += sprintf(&aStr[nNum], "モーションNo.          : (%d)\n", (int)pPlayer->MotionType);
	nNum += sprintf(&aStr[nNum], "プレイヤーの位置       : (%f,%f,%f)\n", pPlayer->pos.x,pPlayer->pos.y,pPlayer->pos.z);
	...
	nNum += sprintf(&aStr[nNum], "\n座標                   : (%4.2f,%4.2f,%4.2f)\n", pModelSet.aPos[0].x, pModelSet.aPos[0].y, pModelSet.aPos[0].z);
	nNum += sprintf(&aStr[nNum], "座標                   : (%4.2f,%4.2f,%4.2f)\n", pModelSet.aPos[1].x, pModelSet.aPos[1].y, pModelSet.aPos[1].z);
	nNum += sprintf(&aStr[nNum], "座標                   : (%4.2f,%4.2f,%4.2f)\n", pModelSet.aPos[2].x, pModelSet.aPos[2].y, pModelSet.aPos[2].z);
	nNum += sprintf(&aStr[nNum], "座標                   : (%4.2f,%4.2f,%4.2f)\n", pModelSet.aPos[3].x, pModelSet.aPos[3].y, pModelSet.aPos[3].z);

	nNum += sprintf(&aStr[nNum], "\n外積値1                : (%4.2f)\n", pModelSet.fVec[0]);
	nNum += sprintf(&aStr[nNum], "外積値2                : (%4.2f)\n", pModelSet.fVec[1]);
	nNum += sprintf(&aStr[nNum], "外積値3                : (%4.2f)\n", pModelSet.fVec[2]);
	nNum += sprintf(&aStr[nNum], "外積値4                : (%4.2f)\n", pModelSet.fVec[3]);
