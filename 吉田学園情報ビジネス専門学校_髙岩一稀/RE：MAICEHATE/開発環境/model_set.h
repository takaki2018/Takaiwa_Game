...
void TexModel(int nCntModelSet);									// モデルのテクスチャ
void VecModel(int nCntModelSet);									// モデルの頂点座標

void VecModelSet(int nCntModelSet);									// モデルの頂点座標
...
ModelSet GetmodelSet(void);											// モデル配置情報の取得
