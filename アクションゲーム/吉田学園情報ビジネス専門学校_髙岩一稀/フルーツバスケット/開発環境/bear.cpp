...
#define TRUN_COUNT			(150)					// ジャンプまでのカウント
...
void TitleBear(void)
{
	...
	{
		SetBear(D3DXVECTOR3(1130.0f, 640.0f, 0.0f), D3DXVECTOR3(-1.0f, 0.0f, 0.0f));
	...
	if (g_Bear.bUse == true && g_Bear.bAppear == true && bSkipTitle == false)
	{
		...
		if (g_Bear.pos.x <= 1000.0f && g_Bear.bEvent == false && g_Bear.bJump == false)
